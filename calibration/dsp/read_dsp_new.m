function [dsp_quad dsp_cubic]=read_dsp_new(dsp_dir,varargin)
% now include bremen xs
...
%     'so2_0','so2_2','so2_3','so2_4','so2_5','so2_6'  
%     'so3_0','so3_2','so3_3','so3_4','so3_5','so3_6' % serduchenko
...
labels={'date','Brw','idx','wl_0','wl_2','wl_3','wl_4','wl_5','wl_6',... 
        ...
        'Ray_0','Ray_2','Ray_3','Ray_4','Ray_5','Ray_6',...
        'so2_0','so2_2','so2_3','so2_4','so2_5','so2_6',...  
        'so3_0','so3_2','so3_3','so3_4','so3_5','so3_6',...
        };
        ...
        if ~arg.Results.process
            try
               ...
               wv_matrix_quad(idx,:)=cat(2,info_(1),dsp_sum.brewnb,indx,dsp_sum.salida.QUAD{end-1}.thiswl,dsp_sum.salida.QUAD{end-1}.fwhmwl/2,...
                                                    ...
                                                    dsp_sum.salida.QUAD{end-1}.so2coeff,dsp_sum.salida.QUAD{end-1}.bremen);        
               wv_matrix_cubic(idx,:)=cat(2,info_(1),dsp_sum.brewnb,indx,dsp_sum.salida.CUBIC{end-1}.thiswl,dsp_sum.salida.CUBIC{end-1}.fwhmwl/2,...
                                                    ...
                                                    dsp_sum.salida.CUBIC{end-1}.so2coeff,dsp_sum.salida.CUBIC{end-1}.bremen...   
                                                );        
            catch exception
               fprintf('%s\n',exception.message);  
               try
...
for l=1:size(dsp_quad,1)
    fprintf(fid_quad,'%f %d %d %7.2f %7.2f %7.2f %7.2f %7.2f %7.2f  %4.2f %4.2f %4.2f %4.2f %4.2f %4.2f  %d %d  %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f  %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f\n\r',dsp_quad(l,:));
    fprintf(fid_cubic,'%f %d %d %7.2f %7.2f %7.2f %7.2f %7.2f %7.2f %4.2f %4.2f %4.2f %4.2f %4.2f %4.2f %d %d %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f  %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f  %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f\n\r',dsp_cubic(l,:));
end
fclose all;
