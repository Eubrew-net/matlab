...
%        Comprobar depuraci�n de outliers. Eliminarlos en su caso??
% 
%%   MODIFICADO:
%  23/07/2010 Isabel  Modificado para que como salida tome el error cometido
%                     al usa la funcion RCI (error individual)
%                     al usar la funci�n RaCI (error al comparar)
%
%  10/08/2010 Juanjo: Retocados los ploteos para hacerlo acorde al resto del report de calibraci�n
% 
...
%                                 depuracion (0 � 1). Para hacer uso de interactivelegend. Por defecto 0
%                                 outlier_flag (0 � 1). Por defecto 0
...
for i=1:length(FilesCI)
    ...
    try
        ...
        % ...a una repetici�n j. As� que una parte Ttodosai podemos tener uno o dos valores.
        ...
        % La primera columna es la L (xlo que a�adimos un espacio vac�o a nuestra fila FH)
        % La primera columna es la Longitud (xlo que a�adimos un espacio vac�o a nuestra fila Ttodosai)
        ...
        % Unimos el resultado con la fila  T tambi�n                
    catch
...
% title('');
% Representamos de la matriz salida.Donde 100 es la posici�n de la fila
%...y cada fila est� asociada a una L.
...
% 
% % Escogemos una longitud de onda en concreto viendo la gr�fica anterioir(por ejemplo la 3200A. fila 68)
% % find(CLongRatiosPFiles(:,1)==longitud de inter�s)
% 
...
% %         % Eliminamos tambi�n los valores para la variable FHj, para que siga siendo
...
% 
% %...MEDIA MENSUAL....................................................
% % Basado en la funci�n mean_month
% try
