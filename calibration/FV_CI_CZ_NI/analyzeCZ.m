...
% OUTPUT
% 
% - wl: Resultados del an�lisis. Matriz (m,6), siendo m el n�mero total de
%       escanes analizados y las siguientes 6 columnas:
%       'Fecha','wl real','wl, m�todo pendientes','Diferencia','wl, m�todo centro masas','Diferencia','Intensidad Lmax'
% 
% - fwhm:  
%
% MODIFICADO:
%      
% 22/07/2010 Isabel: A�adido nombre de Brewer a la gr�fica.
%
...
% 
% 20/10/2010 Isabel: Salen las 3 gr�ficas para las 3 longitudes de onda (2967,3022,3341).
%                    Pero en lugar de salir 3, sale s�lo 1 con los datos
...
%                    repositorio !! yyyy/bdata###. A�adido input opcional plot_flag (default: 1)
...
if plot_flag
    ...
    if length(wich)>1
    disp('�Qu� Hacer con varias longitudes a la vez? TODO'); 
    wich=1;
    end
