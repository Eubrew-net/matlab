function [tabla_avg sl_data,dt_data,rs_data,ap_data]=a1(Cal,varargin)
...
cd(Cal.path_root)
% las funciones no deben necesitar trabajar en un directorio si reciben
% calpath root
...
cd(fullfile(Cal.path_root,'campaigns','Triad_maintenance'));
...
%% Tabla por eventos 
 lbl_avg={'R6','std','R5','std','N','DT high','std','DT low','std','N','HT','std','+5V','std','SL current','std','N',...
          'RS0','std','RS1','std','RS2','std','RS3','std','RS4','std','RS5','std','RS6','std','N'}; 
 event_info=getevents(Cal,'grp',arg.Results.grp); data_tab=meanperiods(aux, event_info);
