function [fig_indv,fig_day,ratio,uv,time,lamda,szar]=comp_sergio(uv1,uv2)

% Función que compara scanes de distintos equipos y rangos de longitudes de
% onda.

% Se tomará como resolución, el espectro de la variable uv1. Deben tener
% formato UV similar a los brewer.
