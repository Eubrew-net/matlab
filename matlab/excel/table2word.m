...
styles={'Tabla 3D effects 1','Tabla Contemporary','Tabla List 5',...
  'Tabla 3D effects 2','Tabla Elegent','Tabla List 6',...
  'Tabla 3D effects 3','Tabla Grid','Tabla List 7',...
  'Tabla Classica 1','Tabla Grid 1','Tabla List 8',...
  'Tabla Classica 2','Tabla Grid 2','Tabla Normal',...
  'Tabla Classica 3','Tabla Grid 3','Tabla Profesional',...
  'Tabla Classica 4','Tabla Grid 4','Tabla Simple 1',...
  'Tabla Colorful 1','Tabla Grid 5','Tabla Simple 2',...
  'Tabla Colorful 2','Tabla Grid 6','Tabla Simple 3',...
  'Tabla Colorful 3','Tabla Grid 7','Tabla Subtle 1',...
  'Tabla con Columnas 1','Tabla Grid 8','Tabla Subtle 2',...
  'Tabla con Columnas 2','Tabla List 1','Tabla Theme',...
  'Tabla con Columnas 3','Tabla List 2','Tabla Web 1',...
  'Tabla con Columnas 4','Tabla List 3','Tabla Web 2',...
  'Tabla con Columnas 5','Tabla List 4','Tabla Web 3'};
...
% Opening Word
Doc = COM.Word.Application;
if ~exist('filename','var')
    Doc.Visible = 1;
    MS = Doc.Documents.Add;
    new = 1;
else
...
if exist('table_title','var')
    Doc.Selection.TypeParagraph;
    Doc.Selection.Text = table_title;
    %Doc.Selection.ParagraphFormat.Alignment = 1;    % Centering Title
    Doc.Selection.Font.Bold = 1;
    Doc.Selection.MoveDown;
    Doc.Selection.TypeParagraph;
end
Doc.Selection.Paste;
Doc.Selection.TypeParagraph;
...
Doc.Selection.MoveUp;
if exist('style','var') Doc.Selection.Style = style;
else Doc.Selection.Style = 'Tabla Normal'; end
%TB = invoke(Doc.Selection.Tables,'Item',1);
%TB.Rows.Alignment = 1;      % Centering Table
Doc.Selection.MoveDown;
