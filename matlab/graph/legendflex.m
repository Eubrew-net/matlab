...
% Not really sure why, but when adding multiple flex-legends to one figure,
% I sometimes lose objects unless I flush the event queue first.

% drawnow; % Think I've fixed this now
