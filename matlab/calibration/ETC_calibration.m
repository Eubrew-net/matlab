...
blinddays={};
blinddays{n_ref}=FINAL_DAYS;
blinddays{n_inst}=FINAL_DAYS;
...
%         % ETC determination
         ...
         f=figure;
         set(f,'Tag','CAL_2P')
         plot(ozone_slant*1000,ms9,'k+','MarkerSize',3);
         hold on
         ...
         ETC_NEW=round(nanmedian(y(:,1)))
         
         
         f=figure;
         set(f,'Tag','CAL_2P_SCHIST')
         ETC_CALC=ms9(j)-o3p(j);
         %ETC_NEW=round(nanmedian(ETC_CALC))
