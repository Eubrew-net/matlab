...
%   240909 : Alberto   a�andido flag de depuracion en SL->sl_avg
%            cuando cambia el sl durante la calibracion los toma como outlier.
%   021109 : Juanjo se distingue el flag_outlier segun para que funci�n sea
%            sl_avg, dt_avg, rs_avg o bien ap_avg
%            En todos los casos ser� 'flag_outlier_??'
