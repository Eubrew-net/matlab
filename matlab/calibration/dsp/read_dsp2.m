...
%     'o3_0','o3_2','o3_3','o3_4','o3_5','o3_6'  'bremen
...
labels={'date','Brw','idx','wl_0','wl_2','wl_3','wl_4','wl_5','wl_6',... 
        ...
        'ozonepos',' zero ','o3_0','o3_2','o3_3','o3_4','o3_5','o3_6',...
        'Ray_0','Ray_2','Ray_3','Ray_4','Ray_5','Ray_6',...
        'Bo3_0','Bo3_2','Bo3_3','Bo3_4','Bo3_5','Bo3_6'};
        ...
        if ~arg.Results.process
            try
               ...
               wv_matrix_quad(idx,:)=cat(2,info_(1),dsp_sum.brewnb,indx,dsp_sum.salida.QUAD{end-1}.thiswl,dsp_sum.salida.QUAD{end-1}.fwhmwl/2,...
                                                    ...
                                                    dsp_sum.salida.QUAD{end-1}.o3coeff,dsp_sum.salida.QUAD{end-1}.raycoeff,dsp_sum.salida.QUAD{end-1}.bremen);        
               wv_matrix_cubic(idx,:)=cat(2,info_(1),dsp_sum.brewnb,indx,dsp_sum.salida.CUBIC{end-1}.thiswl,dsp_sum.salida.CUBIC{end-1}.fwhmwl/2,...
                                                    ...
                                                    dsp_sum.salida.CUBIC{end-1}.o3coeff,dsp_sum.salida.CUBIC{end-1}.raycoeff,dsp_sum.salida.CUBIC{end-1}.bremen);        
            catch exception
               fprintf('%s\n',exception.message);  
               try
...
for l=1:size(dsp_quad,1)
    fprintf(fid_quad,'%f %d %d %7.2f %7.2f %7.2f %7.2f %7.2f %7.2f %4.2f %4.2f %4.2f %4.2f %4.2f %4.2f %d %d %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f   %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f\n\r',dsp_quad(l,:));
    fprintf(fid_cubic,'%f %d %d %7.2f %7.2f %7.2f %7.2f %7.2f %7.2f %4.2f %4.2f %4.2f %4.2f %4.2f %4.2f %d %d %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f  %6.4f %6.4f %6.4f %6.4f %6.4f %6.4f\n\r',dsp_cubic(l,:));
end
fclose all;
