...
function info_log=informes(Cal,n)
if nargin==2
    N=n;
else
    N=1:Cal.n_brw;
...
for in=1 :4
  for ixn=N
     try
      ...
      publish(sprintf('cal_report_%03d%s.m',Cal.brw(ixn),info{in}),options_pub);
      web{ixn,in}= [sprintf('\r\nhttps://www.eubrewnet.org/svn/are2019/html/%03d/html/cal_report_%03da1.html\r\n',[Cal.brw(ixn),Cal.brw(ixn)])];
