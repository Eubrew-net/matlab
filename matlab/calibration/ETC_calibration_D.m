function [ETC,o3_c,m_netc]=ETC_calibration_D(file_setup,summary,A,instrumento,referencia,tsync,oscmax,szasync,C_DAYS,varargin)
...
%% ouliters remove
        [a,b,c,d]=outliers_bp(o3_c(:,7)-o3_c(:,23),3);
        o3_c(d,:)
        o3_c(d,:)=[];
