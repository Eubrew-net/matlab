function xlswrite_date(m,header,colnames,filename);
% xlswrite     Easily create an Excel spreadsheet from MATLAB
%  %transforma la 1º columna en fecha lotus
%  xlswrite(filename,m,header,colnames) creates a Microsoft Excel spreadsheet using
