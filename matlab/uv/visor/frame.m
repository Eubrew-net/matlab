...
h1 = uicontrol('Parent',h0,'Units','points','Callback','frame_s plotscan', ...
...
h1 = uicontrol('Parent',h0,'Units','points', 'ListboxTop',0, ...
	...
	'Tag','Botprev','String','<<','Callback','frame_s prev' ...
   );
% Boton de siguiente ------->next
h1 = uicontrol('Parent',h0, 'Units','points','ListboxTop',0, ...
	'Position',[73.5 204 54.75 20.25], ...
   'Tag','Botprev','String','>>','Callback','frame_s next' ...
   );
% Text X
...
h1 = uicontrol('Parent',h0,'Units','points','ListboxTop',0,'Position',[2.5 86.17241379310346 55 20], ...
   'Tag','B_del_select','String','Borrar Sel','Callback','frame_s del_select','Enable','off');
%  Boton ---> Salvar;
h1 = uicontrol('Parent',h0,'Units','points','ListboxTop',0,'Position',mat6, ...
   'Tag','B_save_mat','String','Save (mat)','Callback','frame_s save_mat','Enable','off');
%  Boton ---> Eliminar Scan
h1 = uicontrol('Parent',h0,'Units','points','ListboxTop',0,'Position',[2.5 61.17241379310345 55 20], ...
   'Tag','B_Supr_scan','String','Supr scan','Callback','frame_s supr_scan','Enable','on');
...
h1 = uicontrol('Parent',h0,'Units','points','ListboxTop',0,'Position',[2.5 11.17241379310345 55 20], ...
   'Tag','B_send_close','String','Send>Close','Callback','frame_s send_close','Enable','on');
...
h1 = uicontrol('Parent',h0,'Units','points','BackgroundColor',[0.752941176470588 0.752941176470588 0.752941176470588], ...
   ...
   'String',' 3D ','Callback','frame_s plot3D');
% Reverse X
h1 = uicontrol('Parent',h0,'Units','points','BackgroundColor',[0.752941176470588 0.752941176470588 0.752941176470588], ...
   ...
   'String',' X reverse ','Callback','frame_s xreverse');
% Log Y
h1 = uicontrol('Parent',h0,'Units','points','BackgroundColor',[0.752941176470588 0.752941176470588 0.752941176470588], ...
